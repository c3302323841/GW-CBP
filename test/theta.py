...
def dg(p_f, p_T_obs, p_M_b, nd):
    ...
    phi_s_h = 5 + (nd + 1) * 0.1 * math.pi  # 源的坐标
        ...
        for a in range(na):  # 循环周期
            ...
            for b in range(nb):  # 寻找最小质量
                ...
                if b > 0 and Re < 0.3 and Re_z[b] / Re_z[b - 1] > 0.5:
                    ...
                    MP = math.log10(math.pow(10, y_predict / 100 * 3))
    ...
    print((nd + 1) * 0.1 * math.pi, find_m_p(p_na, p_nb, p_nc))
